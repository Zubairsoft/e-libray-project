...
let display_order=document.getElementById("model-confirm-order");
let order=document.getElementById("btn-done");
order.addEventListener("click",function(){
display_order.style.display="block";
})
//hidden 
let hide=document.getElementById("display-h");
hide.addEventListener("dblclick",function(){
    document.getElementById("model-confirm-order").style.display="none";
})